...
\title{
Advancing Natural Languages Processing for Understanding and Analysis %of Social Media Content Dynamics
} \let\Title\@title
...
% % % Part 1
\part{NLP Methods for Social Media Analysis}
...
% % % Part 2
% \part{Applying NLP Models to Analyse Information Integrity}
