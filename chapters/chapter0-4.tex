...
Figure \ref{fig:interface} presents our annotation interface. Below we present the instructions provided to annotators along with a small description of each topic.%Figure \ref{fig:instruction} displays the instructions provided to annotators along with a small description of each topic.


\subsubsection*{Annotation Instructions}
\label{sec:appendix:tweet-topic-instructions}
```
\textit{Choose the appropriate topics expressed by the text. Do not work on this HIT if you have already done it before. You can work on the HIT only once, and if we find more than one job from a single worker, we have to reject it. There are three sentences (randomly located) in our HIT that are designed to qualify the annotations whether they give correct topic annotations or not. We can only accept jobs without any errors in those test sentences, and have to reject the job if it has any mistakes in these sentences.}

\medskip

\begin{enumerate}
    \item \textbf{Arts \& Culture:} Content that focuses on the creation and appreciation of various art forms, which evinces some degree of talent, training, or professionalism.
    \item \textbf{Diaries \& Daily Life:} Slice of life, everyday content that illustrates personal opinions, feelings, occasions, and lifestyles.
    \item \textbf{Beauty:} Content focusing on beautification, products, treatments, and editing in order to improve aesthetics.
    \item \textbf{Business \& Entrepreneurs:} Content that relates to money, the economy, and wealth creation broadly, including job tips, career advice, and day in the life.
    \item \textbf{Celebrity \& Pop Culture:} Stars and celebrities, their lives, funny moments, relationships, and fan communities.
    \item \textbf{Fashion \& Style:} Content about fashion, the industry, outfits, looks, shows, street style, collections, and designers, both amateur and professional.
    \item \textbf{Film, TV \& Video:} Traditional media and entertainment, including film and TV, as well as content about Netflix and other streaming shows.
    \item \textbf{Comedy:} Content intended to make the viewer laugh, either by capturing a funny moment, relaying a story, or contriving a situation.
    \item \textbf{Gaming:} Games both real and virtual, the competition, culture, and gameplay itself.
    \item \textbf{Pets \& Animals:} All pets and animals content not contemplated by a child category, including alternative pets (fish, reptiles, birds).
    \item \textbf{Relationships:} Relationship dynamics, jokes, relatable moments, and the like between friend groups and romantic partners.
    \item \textbf{Science \& Technology:} Content on cutting-edge technology, natural phenomena, as well as knowledge and theories about the future and the universe.
    \item \textbf{Family:} Family dynamics, in-jokes, and everyday moments.
    \item \textbf{Music:} Music performance, discussion, experiences, and the like.
    \item \textbf{Travel \& Adventure:} Vacations, travel tips, lodgings, means of conveyance, and the experience of travel.
    \item \textbf{Home Improvement \& Design:} Videos about designing and creating homes and buildings. Home improvement and design as an artistic and/or constructive process.
    \item \textbf{Food \& Dining:} Cooking, restaurants, food visuals, reviews, secret spots, food deals, technique, and ASMR—anything related to food and food culture.
    \item \textbf{Youth \& Student Life:} Moments and memes of life at school and in the classroom, including teachers, events, and the like.
    \item \textbf{Learning \& Educational:} Instructive, informative, educational content that teaches a fact, skill, or topic.
    \item \textbf{Fitness \& Health:} Healthy living and the components thereof, including nutrition, exercise, progress, and wellness.
    \item \textbf{Sports:} All depictions of sports whether enumerated below or not.
    \item \textbf{News \& Social Concern:} Awareness, activism, dialogue, and discussion of social and societal issues and injustices; content that focuses on coverage of newsworthy events, political and otherwise.
    \item \textbf{Other Hobbies:} Pastimes, recreation, and subcultures around hobbies and personal interests.
\end{enumerate}

\medskip

\textit{Please check all the relevant topics to the text when the topic is mixed. Make sure that you check at minimum one topic in each text. If you are unclear or have general feedback for us, feel free to use the comments box.}
'''
...
\begin{figure}[hbt]
    \centering
    \includegraphics[width=\textwidth]{../figures/tweet-topic/trending_filtering.png}
...
\begin{figure}[hbt]
    \centering
    \includegraphics[width=\textwidth]{../figures/tweet-topic/trend.png}
...
% \begin{figure*}[t]
%     \centering
%     \includegraphics[width=\textwidth]{../figures/tweet-topic/instruction.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\textwidth]{../figures/tweet-topic/interface.png}
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=\textwidth]{../figures/tweet-topic/troberta2019_temp_decay.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\textwidth]{../figures/tweet-topic/performance_diff.png}
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=\textwidth]{../figures/tweet-topic/troberta2019_cm_multi.png}
...
\begin{figure}
    \centering
    % Changed from \linewidth to \textwidth as requested
    \scalebox{1}{
    \centering
    \includegraphics[width=\textwidth]{../figures/x-topic/best_models.png}}
    \caption{F1 scores (macro average) of the best overall performing model (\textit{xlmt\_large}) in each setting and language.}
    \label{fig:best_f1}
\end{figure}
...
\centering
\begin{adjustbox}{width=.98\textwidth,center}
\begin{tabular}{|l|l|l|l|l|l|l|l|}
\hline
             & Jan & Feb & Mar & Apr & May   & Jun  & Jul  \\ \hline
UK           & 47,296 & 47,606 & 38,965 & 29,336 & 34,215 & 31,081 & 31,970 \\ \hline
-Scotland    & 11,282 & 13,175 & 8,988  & 6,622  & 7,890  & 5,600  & 3,856  \\ \hline
-Wales       & 5,381  & 5,462  & 3,903  & 3,386  & 3,874  & 3,013  & 3,191  \\ \hline
-N.Ireland   & 5,945  & 6,788  & 5,640  & 4,579  & 5,127  & 6,138  & 4,798  \\ \hline
Spain        & 20,119 & 25,343 & 18,407 & 18,073 & 16,938 & 16,167 & 14,732 \\ \hline
-Catalonia   & 9,512  & 8,386  & 6,463  & 5,537  & 6,389  & 6,030  & 6,047  \\ \hline
-Basque      & 2,103  & 2,299  & 1,478  & 1,287  & 1,230  & 989    & 685    \\ \hline
Greece       & 7,234  & 9,298  & 7,421  & 7,136  & 6,345  & 6,140  & 6,239  \\ \hline
\textbf{ALL} & 108,872& 118,357& 91,265 & 75,956 & 82,008 &75,158 & 71,518 \\ \hline
\end{tabular}
\end{adjustbox}
\end{subtable}
...
\hline
             & Aug   & Sep    & Oct    & Nov    & Dec    & \textbf{Total} \\ \hline
UK           & 22,044 & 27,509 & 29,557 & 31,330 & 29,026 & 399,935   \\ \hline
-Scotland    & 5,295  & 6,285  & 5,301  & 6,427  & 6,241  & 86,962    \\ \hline
-Wales       & 2,393  & 2,864  & 2,826  & 3,410  & 3,084  & 42,787    \\ \hline
-N.Ireland   & 3,484  & 4,947  & 4,505  & 4,452  & 5,391  & 61,794    \\ \hline
Spain        & 11,595 & 15,376 & 14,753 & 13,823 & 13,175 & 198,501   \\ \hline
-Catalonia   & 3,729  & 5,940  & 5,856  & 5,376  & 5,255  & 74,520    \\ \hline
-Basque      & 843    & 1,040  & 1,118  & 1,161  & 1,091  & 15,324    \\ \hline
Greece       & 4,300  & 6,060  & 5,458  & 5,941  & 5,083  & 76,655    \\ \hline
\textbf{ALL} & 53,683 & 70,021 & 69,374 & 71,920 & 68,346 & 956,478   \\ \hline
\end{tabular}
\end{adjustbox}
...
\hline
\multirow{3}{*}{Type} & \multirow{3}{*}{Model} & \multirow{3}{*}{\begin{tabular}[c]{@{}l@{}}Train \\ Lang\end{tabular}} & \multicolumn{2}{c|}{\multirow{2}{*}{Domain}} & \multicolumn{4}{c|}{United Kingdom} & \multicolumn{4}{c|}{Spain} & \multicolumn{4}{c|}{Greece} \\ \cline{6-17} 
...
\multirow{10}{*}{\rot{Multilingual}} & \multirow{3}{*}{XLMT} & Mono &  & \checkmark & 70 & 72 & 78 & 75 & 67 & 66 & 80 & 80 & 74 & 76 & 73 & \textbf{74} \\ \cline{3-17} 
 ...
 & \multirow{3}{*}{XTS} & Mono & \checkmark &  & 72 & 72 & 78 & 79 & 68 & 71 & 77 & 82 & 65 & 69 & 64 & 68 \\ \cline{3-17} 
 ...
 & \multirow{4}{*}{XLMR} & Mono &  & \checkmark & 69 & 72 & 77 & 75 & 60 & 65 & 75 & 80 & 74 & 75 & 73 & 73 \\ \cline{3-17} 
...
\multirow{6}{*}{\rot{Monolingual}} & \multirow{2}{*}{RB} & Mono &  & \checkmark & 68 & 73 & 78 & 77 & 64 & 70 & 78 & 86 & 56 & 57 & 50 & 52 \\ \cline{3-17} 
 &  & Mono & \checkmark & \checkmark & 75 & 70 & 80 & 75 & 70 & 78 & 80 & \textbf{87} & 56 & 62 & 49 & 58 \\ \cline{2-17} 
 & \multirow{2}{*}{TW-S} & Mono & \checkmark &  & 73 & 72 & 80 & 79 & \multicolumn{8}{c|}{\multirow{4}{*}{}} \\ \cline{3-9}
 &  & Mono & \checkmark & \checkmark & 76 & 67 & 81 & 74 & \multicolumn{8}{c|}{} \\ \cline{2-9}
 & \multirow{2}{*}{BT-S} & Mono & \checkmark &  & 77 & \textbf{76} & \textbf{83} & \textbf{83} & \multicolumn{8}{c|}{} \\ \cline{3-9}
...
- & Base &  &  &  & 22 & 22 & 33 & 33 & 20 & 21 & 30 & 32 & 17 & 20 & 27 & 30 \\ \hline
\end{tabular}
\end{adjustbox}
\caption{Average F1 scores along with the average of F1 scores of positive and negative classes (F1\textsuperscript{PN}) when trained/evaluated with cross-validation (CV) and on the $\sim$900/100 train/test split. The results displayed are the averages of three runs. Domain indicates the data used for training the models. `In' domain indicates models trained on the labelled data collected (Section \ref{sec:annotation}), `Out' indicates the model has been finetuned on other sentiment analysis datasets (see Section \ref{sec:expsetting}). Finally, `Mono' indicates that the model was trained with data from only one language, while `Multi' shows models that were trained with data from all available languages. Models: XTS: XLM-T-Sent, RB: RoBERTa-Base, TW-S: TweetEval-Sent, BT-S: Bertweet-Sent, SVM: SVM, LSTM: LSTM, Base: Baseline.}
...
\hline
\textbf{variable} & \textbf{UK} & \textbf{Spain} & \textbf{Greece} \\ \hline
const             & 75.9854*    & 96.6305*       & 96.6305*        \\ \hline
emojis            & -7.9482*    & -9.7004*       & -9.7004*        \\ \hline
has\_url          & -17.524*    & 26.56*         & 26.56*          \\ \hline
hashtags          & -7.811*     & -41.0476*      & -41.0476*       \\ \hline
mentions          & -40.4977*   & -63.0461*      & -63.0461*       \\ \hline
max\_score        & -42.5478*   & -39.615*       & -39.615*        \\ \hline
\end{tabular}
\end{subtable}
...
const             & 72.8914*         \\ \hline
emojis            & -5.1085*         \\ \hline
has\_url          & -1.3613          \\ \hline
hashtags          & -20.0335*        \\ \hline
mentions          & -41.0511*        \\ \hline
max\_score        & -43.16*          \\ \hline
\end{tabular}
\end{subtable}

\caption{Coefficients for the OLS model when using tweets from the combined 2021 UK, Spain, Greece parliaments (bottom) and for each individual parliament (top). Dependent variable is the retweet count while XLM-T's softmax scores (negative and positive sentiment) are utilised (sent score) as independent variables. $*$ indicates p-value $< 0.05$}
...
\multirow{2}{*}{\textbf{variable}} &
  ...
  \multicolumn{2}{c|}{\textbf{Greece}} \\ \cline{2-7} 
 &
...
const     & \multicolumn{1}{c|}{3.7006*} & 4.4486* & \multicolumn{1}{c|}{3.61*} & 4.1586* & \multicolumn{1}{c|}{2.3372*} & 2.8278* \\ \hline
emojis    & \multicolumn{1}{c|}{-0.3277*} & -0.2978* & \multicolumn{1}{c|}{-0.2114*} & -0.1946* & \multicolumn{1}{c|}{-0.3298*} & -0.3639* \\ \hline
has\_url  & \multicolumn{1}{c|}{-0.3798*} & -0.8422* & \multicolumn{1}{c|}{0.41*} & 0.0827* & \multicolumn{1}{c|}{-0.1871*} & -0.305* \\ \hline
hashtags  & \multicolumn{1}{c|}{-0.4001*} & -0.5168* & \multicolumn{1}{c|}{-0.5878*} & -0.6266* & \multicolumn{1}{c|}{-0.3372*} & -0.41* \\ \hline
mentions  & \multicolumn{1}{c|}{-1.4615*} & -0.8382* & \multicolumn{1}{c|}{-0.929*} & -0.8291* & \multicolumn{1}{c|}{-0.9082*} & -0.7696* \\ \hline
neg       & \multicolumn{1}{c|}{1.3014*} & 1.0566* & \multicolumn{1}{c|}{1.1818*} & 1.0028* & \multicolumn{1}{c|}{0.9232*} & 0.6859* \\ \hline
pos       & \multicolumn{1}{c|}{-0.1486*} & -0.1855* & \multicolumn{1}{c|}{0.5513*} & 0.4503* & \multicolumn{1}{c|}{0.3229*} & 0.2315* \\ \hline
\end{tabular}
\end{adjustbox}
\end{subtable}
...
\hline
\multirow{2}{*}{\textbf{variable}} & 
  \multicolumn{2}{c|}{\textbf{Overall}} \\ \cline{2-3}
 & \textbf{Poisson} & \textbf{zero Poisson} \\ \hline
const     & 3.4035* & 4.0809* \\ \hline
emojis    & -0.193* & -0.1769* \\ \hline
has\_url  & 0.013* & -0.3695* \\ \hline
hashtags  & -0.5219* & -0.6281* \\ \hline
mentions  & -1.0543* & -0.7944* \\ \hline
neg       & 1.4129* & 1.1709* \\ \hline
pos       & 0.2295* & 0.1629* \\ \hline
\end{tabular}
\end{subtable}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.98\linewidth]{../figures/spreaders/pan-xgb-topics.png}
    \caption{Topic distribution comparison between the \textit{PAN} dataset and the predictions from the \textit{XGB} model.}
    \label{fig:topics-distribution-xgb}
\end{figure}
...
Figures \ref{fig:rwanda_controv_temporal} \& \ref{fig:rwanda_controv_contextual} displays the average controversiality per thread before and after the introduction of the \textit{Rwanda} trigger point in the Temporal and Contextual control settings.

Figures \ref{fig:rwanda_contextual} \& \ref{fig:rwanda_temporal} displays the distribution of comments posted before and after the introduction of the \textit{Rwanda} trigger point in the Contextual and Temporal control settings.

Figures \ref{fig:sentiment_space_appendix_brexit_feminism} \& \ref{fig:sentiment_space_appendix_rwanda_nhs} displays the distribution of negative comments, based on their sentiment, posted before and after the introduction of the \textit{Brexit, Feminism, Rwanda, and NHS} trigger points in the Space control setting.
...
% Original (combined) figure, now commented out:
% \begin{figure}[ht]
%     \centering
%     % First image
...
% Split into two separate figures as requested

% Figure 1: Temporal setting
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{../figures/triggers/controversiality/rwanda_temporal.png}
    \caption{Average controversiality per thread in the \textbf{Temporal} setting and its respective treatment groups for the trigger point \textit{Rwanda}.}
    \label{fig:rwanda_controv_temporal}
\end{figure}

% Figure 2: Contextual setting
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{../figures/triggers/controversiality/rwanda_semantics.png}
    \caption{Average controversiality per thread in the \textbf{Contextual} setting and its respective treatment groups for the trigger point \textit{Rwanda}.}
    \label{fig:rwanda_controv_contextual}
\end{figure}



% Original figure (now commented out):
% \begin{figure}[ht]
%     \centering
...
% Split into two figures as requested

% First figure: Contextual comparison
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{../figures/triggers/counts/counts_sem/rwanda.png}
    \caption{Rwanda Treatment and Control distributions of comments in the \textbf{Contextual} setting.}
    \label{fig:rwanda_contextual}
\end{figure}

% Second figure: Temporal comparison
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{../figures/triggers/counts/counts_temp/rwanda.png}
    \caption{Rwanda Treatment and Control distributions of comments in the \textbf{Temporal} setting.}
    \label{fig:rwanda_temporal}
\end{figure}
...
% First figure: Rows 1 and 2 (Brexit & Feminism)
\begin{figure}[ht]
    \centering
    % Row 1
    \includegraphics[width=0.75\textwidth]{../figures/triggers/sentiment/space/brexit.png}
    ...
    % Row 2
    \includegraphics[width=0.75\textwidth]{../figures/triggers/sentiment/space/feminism.png}
    \caption{Distribution of negatively charged comments in the Treatment and Control (Space) groups for \textit{Brexit} (top) and \textit{Feminism} (bottom).}
    \label{fig:sentiment_space_appendix_brexit_feminism}
\end{figure}

% Second figure: Row 3 (Rwanda & NHS)
\begin{figure}[ht]
    \centering
    % Row 3
    \includegraphics[width=0.49\textwidth]{../figures/triggers/sentiment/space/rwanda.png}
    \hfill
    \includegraphics[width=0.49\textwidth]{../figures/triggers/sentiment/space/nhs.png}
    \caption{Distribution of negatively charged comments in the Treatment and Control (Space) groups for \textit{Rwanda} (left) and \textit{NHS} (right).}
    \label{fig:sentiment_space_appendix_rwanda_nhs}
\end{figure}
...
Figures \ref{fig:parallel_trends_h1} \& \ref{fig:parallel_trends_h2} display the results of the Parallel Trends Assumption testing for all experiments as described in H1 and H2.
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{../figures/triggers/robustness_event_study_H1.pdf}
    \caption{Testing the Parallel Trends Assumption with event studies (Experiments from H1). Individual studies in grey, their time-wise mean in purple.}
    \label{fig:parallel_trends_h1}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{../figures/triggers/robustness_event_study_H2.pdf}
    \caption{Testing the Parallel Trends Assumption with event studies (Experiments from H2). Individual studies in grey, their time-wise mean in purple.}
    \label{fig:parallel_trends_h2}
\end{figure}
