...
\noindent  \textbf{XLM-R (xlmr)} \cite{XLMR}, a RoBERTa-like model trained on the CommonCrawls corpus \cite{wenzek2020ccnet} on 100 languages; and \textbf{XLM-T (xlmt)} \cite{barbieri-etal-2022-xlm}, another XLM-R based model that utilises the last XLM-R checkpoint and further trains on a diverse dataset of over 1 billion tweets spanning over 30 languages.
