...
\begin{figure}
    \centering
    \includegraphics[width=10.5cm]{../figures/thesis_diagram.png}
    \caption{Outline of the thesis. The grey color indicates connections between chapters of Part 1 and Part 2. \todo[inline]{WIP: (color code TweetTopic and Hate speech maybe?)}}
...
\begin{figure}
    ...
    \caption{Timeline of papers publications along with major advancments in \ac{NLP}.\todo[inline]{WIP}}
