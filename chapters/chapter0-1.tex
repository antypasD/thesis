...
\ac{NLP} techniques, along with specialized computational models, have long been used to process, manipulate, and extract insights from textual data \cite{jones1994natural,cambria2014jumping}. Early work focused on techniques such as dictionary or rule-based approaches, as well as traditional \ac{ML} models like \ac{SVMs}, regression models, and decision trees, which often utilized \ac{BoW} approaches to represent textual features. However, with the advent of \ac{PLMs} such as \textit{BERT} \cite{DBLP:journals/corr/abs-1810-04805} and more recently \ac{LLMs} like \textit{GPT-3} \cite{GPT3}, processing and extracting insights from textual data has become easier.
