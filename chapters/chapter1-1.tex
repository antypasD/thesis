...
Finally, while this first iteration of {\TweetTopic} focuses on English, our initial aim was to apply the same methodology to other languages. We subsequently carry this out in \Autoref{ch:x-topic}, utilising the guidelines and data construction process described in Section \ref{data} as a foundation.
