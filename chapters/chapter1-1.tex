...
\multicolumn{1}{|c|}{\multirow{2}{*}{\textbf{Class}}} &
  ...
  \multicolumn{2}{c|}{\textbf{TimeLM-21}} \\ \cline{2-9} 
\multicolumn{1}{|c|}{} &
  \multicolumn{1}{c|}{\textbf{temp}} & \textbf{rand} &
  \multicolumn{1}{c|}{\textbf{temp}} & \textbf{rand} &
  \multicolumn{1}{c|}{\textbf{temp}} & \textbf{rand} &
  \multicolumn{1}{c|}{\textbf{temp}} & \textbf{rand} \\ \hline
\begin{tabular}[c]{@{}l@{}}arts \& \\ culture\end{tabular} & \multicolumn{1}{c|}{28.0} & \textbf{44.0} & \multicolumn{1}{c|}{9.8} & \textbf{28.2} & \multicolumn{1}{c|}{21.3} & \textbf{39.1} & \multicolumn{1}{c|}{35.4} & \textbf{44.8} \\ \hline
\begin{tabular}[c]{@{}l@{}}business \& \\ entrepreneurs\end{tabular} & \multicolumn{1}{c|}{50.9} & 56.5 & \multicolumn{1}{c|}{\textbf{59.7}} & 54.5 & \multicolumn{1}{c|}{\textbf{58.6}} & 55.3 & \multicolumn{1}{c|}{\textbf{56.3}} & 54.0 \\ \hline
\begin{tabular}[c]{@{}l@{}}celebrity \& \\ pop culture\end{tabular} & \multicolumn{1}{c|}{50.5} & \textbf{59.6} & \multicolumn{1}{c|}{43.7} & \textbf{54.9} & \multicolumn{1}{c|}{\textbf{48.6}} & 47.8 & \multicolumn{1}{c|}{46.4} & \textbf{57.6} \\ \hline
\begin{tabular}[c]{@{}l@{}}diaries \& \\ daily life\end{tabular} & \multicolumn{1}{c|}{43.5} & \textbf{49.3} & \multicolumn{1}{c|}{44.6} & \textbf{49.9} & \multicolumn{1}{c|}{44.5} & \textbf{51.2} & \multicolumn{1}{c|}{44.7} & \textbf{49.8} \\ \hline
family & \multicolumn{1}{c|}{52.8} & \textbf{63.4} & \multicolumn{1}{c|}{46.1} & \textbf{49.1} & \multicolumn{1}{c|}{46.4} & \textbf{55.2} & \multicolumn{1}{c|}{53.1} & \textbf{56.2} \\ \hline
\begin{tabular}[c]{@{}l@{}}fashion \& \\ style\end{tabular} & \multicolumn{1}{c|}{66.4} & \textbf{77.4} & \multicolumn{1}{c|}{56.0} & \textbf{68.8} & \multicolumn{1}{c|}{\textbf{66.4}} & 75.2 & \multicolumn{1}{c|}{67.2} & \textbf{75.2} \\ \hline
\begin{tabular}[c]{@{}l@{}}film tv \& \\ video\end{tabular} & \multicolumn{1}{c|}{64.7} & \textbf{71.3} & \multicolumn{1}{c|}{66.8} & \textbf{69.2} & \multicolumn{1}{c|}{66.1} & \textbf{72.2} & \multicolumn{1}{c|}{65.4} & \textbf{70.6} \\ \hline
\begin{tabular}[c]{@{}l@{}}fitness \& \\ health\end{tabular} & \multicolumn{1}{c|}{62.4} & \textbf{65.4} & \multicolumn{1}{c|}{\textbf{48.2}} & 38.7 & \multicolumn{1}{c|}{\textbf{55.7}} & 42.2 & \multicolumn{1}{c|}{58.6} & 52.6 \\ \hline
\begin{tabular}[c]{@{}l@{}}food \& \\ dining\end{tabular} & \multicolumn{1}{c|}{\textbf{79.3}} & 68.2 & \multicolumn{1}{c|}{\textbf{74.5}} & 65.7 & \multicolumn{1}{c|}{\textbf{75.4}} & 70.7 & \multicolumn{1}{c|}{\textbf{80.4}} & 71.6 \\ \hline
gaming & \multicolumn{1}{c|}{63.8} & \textbf{69.1} & \multicolumn{1}{c|}{66.1} & \textbf{67.6} & \multicolumn{1}{c|}{64.6} & \textbf{69.2} & \multicolumn{1}{c|}{64.8} & 71.2 \\ \hline
\begin{tabular}[c]{@{}l@{}}learning \& \\ educational\end{tabular} & \multicolumn{1}{c|}{49.8} & 45.8 & \multicolumn{1}{c|}{\textbf{42.9}} & 36.2 & \multicolumn{1}{c|}{\textbf{49.3}} & 47.1 & \multicolumn{1}{c|}{\textbf{48.9}} & 47.0 \\ \hline
music & \multicolumn{1}{c|}{87.4} & \textbf{88.1} & \multicolumn{1}{c|}{86.9} & \textbf{87.2} & \multicolumn{1}{c|}{\textbf{88.1}} & 87.8 & \multicolumn{1}{c|}{86.9} & \textbf{88.2} \\ \hline
\begin{tabular}[c]{@{}l@{}}news \& \\ social concern\end{tabular} & \multicolumn{1}{c|}{85.5} & \textbf{85.9} & \multicolumn{1}{c|}{83.5} & \textbf{84.3} & \multicolumn{1}{c|}{84.4} & \textbf{86.2} & \multicolumn{1}{c|}{84.5} & \textbf{85.0} \\ \hline
other hobbies & \multicolumn{1}{c|}{31.7} & \textbf{35.4} & \multicolumn{1}{c|}{\textbf{23.1}} & 21.5 & \multicolumn{1}{c|}{27.7} & \textbf{30.3} & \multicolumn{1}{c|}{31.1} & 26.2 \\ \hline
relationships & \multicolumn{1}{c|}{39.3} & \textbf{56.8} & \multicolumn{1}{c|}{36.8} & \textbf{51.2} & \multicolumn{1}{c|}{35.3} & \textbf{51.6} & \multicolumn{1}{c|}{44.5} & \textbf{54.0} \\ \hline
\begin{tabular}[c]{@{}l@{}}science \& \\ technology\end{tabular} & \multicolumn{1}{c|}{52.1} & \textbf{59.4} & \multicolumn{1}{c|}{46.9} & \textbf{53.2} & \multicolumn{1}{c|}{50.5} & \textbf{56.0} & \multicolumn{1}{c|}{50.2} & \textbf{52.1} \\ \hline
sports & \multicolumn{1}{c|}{94.6} & \textbf{95.4} & \multicolumn{1}{c|}{\textbf{95.4}} & 94.4 & \multicolumn{1}{c|}{\textbf{95.6}} & 94.8 & \multicolumn{1}{c|}{\textbf{95.2}} & 94.8 \\ \hline
\begin{tabular}[c]{@{}l@{}}travel \& \\ adventure\end{tabular} & \multicolumn{1}{c|}{46.3} & \textbf{59.9} & \multicolumn{1}{c|}{\textbf{38.5}} & 0.0 & \multicolumn{1}{c|}{\textbf{57.1}} & 56.0 & \multicolumn{1}{c|}{52.2} & 54.7 \\ \hline
\begin{tabular}[c]{@{}l@{}}youth \& \\ student life\end{tabular} & \multicolumn{1}{c|}{21.0} & \textbf{46.0} & \multicolumn{1}{c|}{31.6} & \textbf{35.2} & \multicolumn{1}{c|}{\textbf{50.4}} & 43.6 & \multicolumn{1}{c|}{50.8} & \textbf{51.0} \\ \hline
\textbf{samples avg} & \multicolumn{1}{c|}{74.4} & \textbf{76.4} & \multicolumn{1}{c|}{\textbf{73.8}} & 73.2 & \multicolumn{1}{c|}{74.3} & \textbf{75.2} & \multicolumn{1}{c|}{74.7} & \textbf{75.2} \\ \hline
\textbf{macro avg} & \multicolumn{1}{c|}{56.3} & \textbf{63.0} & \multicolumn{1}{c|}{52.7} & \textbf{53.1} & \multicolumn{1}{c|}{57.2} & \textbf{59.6} & \multicolumn{1}{c|}{58.8} & \textbf{60.9} \\ \hline
\end{tabular}}
\caption{
