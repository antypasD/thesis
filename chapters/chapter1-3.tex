...
The previous two chapters, Chapters \ref{ch:tweet-topic} \& \ref{ch:xtopic}, focused on the development of datasets and models tailored for topic classification on social media. In this chapter, we shift our focus to a different but related task: hate speech detection. We explore how the data used to train hate speech detection models can impact their performance and generalisation across different datasets. 
