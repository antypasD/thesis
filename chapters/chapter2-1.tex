...
This chapter reproduces verbatim our paper \textit{A large-scale multilingual Twitter analysis on the role of sentiment in political communication}, published in the journal Online Social Networks and Media, 2023 (\Autoref{ch:intro:publications}, \Autoref{publication:5}), with only minor modifications to presentation. It corresponds directly to the contributions outlined in \Autoref{ch:intro:contributions:part2}, specifically \Autoref{contribution:4}, \textit{Politics and Negativity}.
