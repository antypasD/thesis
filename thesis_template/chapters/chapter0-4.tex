...
Figure \ref{fig:rwanda_controv_temporal_semantic} displays the average controversiality per thread before and after the introduction of the \textit{Rwanda} trigger point in the Temporal and Semantic control settings.

Figure \ref{fig:rwanda_temporal_semantic} displays the distribution of comments posted before and after the introduction of the \textit{Rwanda} trigger point in the Temporal and Semantic control settings.

Figure \ref{fig:sentiment_space} displays the distribution of negative comments, based on their sentiment, posted before and after the introduction of the \textit{Brexit, Feminism, Rwanda, and NHS} trigger points in the Space control setting.
...
\begin{figure*}[ht]
    ...
    \begin{subfigure}[b]{1\columnwidth}
        \centering
        \includegraphics[width=\textwidth]{../figures/triggers/counts/overall/brexit.png}
        \caption{Brexit}
        \label{fig:image1a}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{1\columnwidth}
        \centering
        \includegraphics[width=\textwidth]{../figures/triggers/counts/overall/feminism.png}
        \caption{Feminism}
        \label{fig:image1b}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../figures/triggers/counts/overall/nhs.png}
        \caption{NHS}
        \label{fig:image1c}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../figures/triggers/counts/overall/rwanda.png}
        \caption{Rwanda}
        \label{fig:image1d}
    \end{subfigure}
        \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../figures/triggers/counts/overall/vaccine.png}
        \caption{Vaccine}
        \label{fig:image1e}
    \end{subfigure}
    
    \caption{Absolute count of posts before and after each trigger point.}
...
\begin{figure*}[ht]
    ...
    \begin{subfigure}[b]{1\columnwidth}
        ...
        \caption{Semantic Setting}
        \label{fig:image2b}
    \end{subfigure}

    
    \caption{Average controversiality per thread in the Temporal and Semantic settings and their respective treatment groups, for the trigger point \textit{Rwanda}.}
...
\begin{figure*}[ht]
    ...
    \begin{subfigure}[b]{1\columnwidth}
        ...
        \caption{Temporal Comparison}
        \label{fig:image3b}
    \end{subfigure}

    \caption{Rwanda Treatment and Control distributions of comments in the Semantic and Temporal settings.}
...
\begin{figure*}[ht]
    ...
    \begin{subfigure}[b]{1\columnwidth}
        \centering
        \includegraphics[width=\textwidth]{../figures/triggers/sentiment/space/brexit.png}
        \caption{Brexit}
        \label{fig:image4a}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{1\columnwidth}
        \centering
        \includegraphics[width=\textwidth]{../figures/triggers/sentiment/space/feminism.png}
        \caption{Feminism}
        \label{fig:image4b}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../figures/triggers/sentiment/space/rwanda.png}
        \caption{Rwanda}
        \label{fig:image4c}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../figures/triggers/sentiment/space/nhs.png}
        \caption{NHS}
        \label{fig:image4d}
    \end{subfigure}
